...
| `isaac_sim/configs/environments/kujiale_0026_A_to_B_door_open.spawn.yaml` | 当前酷家乐 0026 开门场景的 `mapping_start` 标定，以及由同一变换核验的 `long_route_start_g1`；绑定 `warehouse_new` 的 Map Pose、bundle SHA256 和不确定度。 |
