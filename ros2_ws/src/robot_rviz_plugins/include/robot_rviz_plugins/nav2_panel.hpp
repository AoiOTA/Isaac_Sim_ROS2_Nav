...
#ifndef ROBOT_RVIZ_PLUGINS__NAV2_PANEL_HPP_
#define ROBOT_RVIZ_PLUGINS__NAV2_PANEL_HPP_
...
private:
  ...
  bool parseLoopValue(std::string & loop, int & value);
  ...
  QPointer<InitialThread> initial_thread_;
  QFutureSynchronizer<void> async_tasks_;
...
#endif  //  ROBOT_RVIZ_PLUGINS__NAV2_PANEL_HPP_
