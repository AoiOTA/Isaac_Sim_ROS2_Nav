...
def test_matching_isaac_v4_kinematics_is_accepted(tmp_path):
    from robot_odometry.robot_profile import load_robot_profile
...
@pytest.mark.parametrize(
    ...
    [
        ('runtime_provenance.schema_version', 3, 'schema_version'),
        ('runtime_provenance.schema_version', 4.0, 'schema_version'),
