...
#ifndef ROBOT_SLAM_SOLVER__CERES_SOLVER_HPP_
#define ROBOT_SLAM_SOLVER__CERES_SOLVER_HPP_
...
#include "robot_slam_solver/ceres_utils.hpp"
...
using ConstGraphIterator =
  std::unordered_map<int, Eigen::Vector3d>::const_iterator;

class ConfigurableCeresSolver : public karto::ScanSolver
{
public:
  ConfigurableCeresSolver();
  virtual ~ConfigurableCeresSolver();
...
private:
  ...
  // ros
  rclcpp::Logger logger_{rclcpp::get_logger("ConfigurableCeresSolver")};
};

}  // namespace robot_slam_solver

#endif  // ROBOT_SLAM_SOLVER__CERES_SOLVER_HPP_
