...
def test_v6_wrapper_is_canonical_phase1_grid_entry():
    ...
    assert 'v6_kujiale_clearance_r2.yaml' in source
    assert 'v6_kujiale_clearance_r2_gvg_v1.geojson' in source
...
def test_v6_phase1_isaac_disables_dynamic_actors():
    ...
    assert 'kujiale_0026_A_to_B_door_open.v6_clearance_r2.spawn.yaml' in source
    assert 'isaac_sim/assets/environments/v6_kujiale_clearance_r2' in source
